...
class AccountController extends Controller
{
    ...
    {
        $validator = Validator::make($request->all(), [
            'username' => 'required|min:5|alpha_num|unique:accounts,username',
            'password' => 'required|min:6',
            'name' => 'required|min:3|regex:/^[a-zA-ZÀ-ÿẠ-ỹ\s]+$/',
            'phone' => 'required|digits_between:9,12|numeric|regex:/^0\d{8,11}$/',
        ], [
            'username.required' => 'Vui lòng nhập tài khoản',
            ...
            'name.regex' => 'Họ tên chỉ được chứa chữ',
            'phone.required' => 'Vui lòng nhập số điện thoại',
            'phone.digits_between' => 'Số điện thoại phải có từ 9 đến 12 số',
    ...
    {
        $validator = Validator::make($request->all(), [
            'username' => 'required|min:6|max:255|unique:accounts,username',
