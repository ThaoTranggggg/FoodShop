...
class DiscountController extends Controller
{
    ...
    public function API_create_discount(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'percent.required' => 'Tỉ lệ giảm giá không được để trống',
            'percent.numeric' => 'Tỉ lệ giảm giá phải là số',
            'percent.min' => 'Tỉ lệ giảm giá phải lớn hơn 0',
            'percent.max' => 'Tỉ lệ giảm giá phải nhỏ hơn 100',
        ]);
